...
The electronic transfer integral\index{electronic coupling}\index{transfer 
integral|see{electronic coupling}} element $J_{ij}$ entering the Marcus rates in 
\equ{marcus} is defined as
\begin{equation}
...
usual choice for the diabatic wavefunctions $\phi_i$\index{diabatic states} is 
...
realistic morphology. Considering that the number of dimers for which \equ{TI} 
