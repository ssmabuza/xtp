\section{Master equation} \label{sec:kmc}
...
The solution of \equ{master} is be obtained by using kinetic Monte Carlo (KMC) 
...
\votcacommand{KMC for multiple carriers of the same type in periodic boundary 
conditions}{\cmdkmc}
